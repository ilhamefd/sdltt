...
--
-- Host: 127.0.0.1
-- Generation Time: 24 Jul 2017 pada 11.47
-- Versi Server: 5.6.26
-- PHP Version: 5.6.12
...
(1, 'jajaran_perangkat', '<p>Test jajaran perangkat desa</p>\r\n'),
...
(3, 'visi_misi', '<p>test visi misi</p>\r\n'),
(4, 'bpd', ''),
(5, 'lpmd', ''),
(6, 'pkk', ''),
(7, 'karangtaruna', ''),
...
INSERT INTO `lapor` (`id`, `nik`, `nama`, `alamat`, `lokasi`, `foto`) VALUES
(1, '12345', 'ilham', 'malang', 'malang', '');
