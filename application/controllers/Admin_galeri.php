...
class Admin_galeri extends CI_Controller {
	...
	public function index() {
		...
		$data=array('title'=>'Galeri Kegiatan Siswa',
					'isi'  =>'adminpages/kegiatan/galeri/index'
					);
	...
	public function tambah()
	{
		...
		$data=array('title'=>'Tambah Galeri Kegiatan Siswa',
					'isi'  =>'adminpages/kegiatan/galeri/add'
					);
	...
	public function act_add(){
        ...
        if($_FILES['img']['name'])
        {
            if ($this->upload->do_upload('img'))
            {
                ...
                redirect('admin_galeri'); //jika berhasil maka akan ditampilkan view vupload
            }else{
                ...
                redirect('admin_galeri'); //jika gagal maka akan ditampilkan form upload
            }
        }
  ...
  public function edit($id)
  {
    ...
    $data=array(
          ...
          'isi'  =>'adminpages/kegiatan/galeri/edit'
            );
