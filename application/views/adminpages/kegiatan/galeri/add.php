            ...
            <div class="col-lg-12">
				<div class="panel panel-default">
				    ...
				    <div class="panel-body">    
				        <form role="form" method="post" id="myform" action="<?php echo base_url(); ?>admin_galeri/act_add" enctype="multipart/form-data">
				        	<div class="col-lg-3">
							    <label>Judul</label>
						    </div>        	
						    <div class="col-lg-9">
						    ...
						    <div class="col-lg-9">
						    <a href="<?php echo site_url('admin_galeri') ?>" class="btn btn-warning">Kembali</a>
