                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<?php echo site_url('admin_galeri/tambah') ?>" class="btn btn-success"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Data</a>
                            </div>
                        
                        <form action="<?php echo base_url().'admin_bpd/simpan';?>" method="post">
                              ...
                              <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                  ...
                                  <td width="150px" class="text-center">
                                    <a href="<?php echo site_url('admin_galeri/edit/'.$value->id.'') ?>"><span class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </span></a> 
  ...
  $(document).on("click",".confirm",function(){
    ...
    swal({
        ...
        closeOnConfirm: true,
         ...
         $.ajax({
            url:"Admin_galeri/del/",
            type: "POST",
            data:{id:id},
            success: function(){
                swal("Success!","Penghapusan data berhasil","success");
                    setTimeout(function() {
                        window.location.href = "<?php echo site_url('admin_galeri'); ?>";
                    }, 1000);
            }
         });
      });
