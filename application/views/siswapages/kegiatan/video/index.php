                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <a href="<?php echo site_url('siswa_kegiatan_video/show_add') ?>" class="btn btn-success"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Video</a>
                            </div>
                                        ...
                                        <?php $i = 1;
                                          foreach ($record as $key => $value) { ?>
                                            <tr class="odd gradeX">
                                              ...
                                              <td class="col-md-2">
                                                <center>
                                                    <a href="<?php echo site_url('siswa_kegiatan_video/show_edit/'.$value->id.'') ?>"><span class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </span></a> 
 ...
 $(document).on("click",".confirm",function(){
        ...
        swal({
            ...
            closeOnConfirm: true,
             ...
             $.ajax({
                url:"siswa_kegiatan_video/delete/",
                type: "POST",
                data:{id:id},
                success: function(){
                    swal("Success!","Penghapusan video berhasil","success");
                        setTimeout(function() {
                            window.location.href = "<?php echo site_url('siswa_kegiatan_video'); ?>";
                        }, 1000);
                }
             });
        });
